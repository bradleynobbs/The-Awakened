 ...
 * no real system behind it yet (Events, Leaderboard, Clan, Profile) —
 * one component instead of four near-identical screens, following
 * Store.tsx's existing "honest coming soon" precedent rather than a
 * silent dead click. */
