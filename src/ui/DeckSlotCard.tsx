 ...
 * hero's own element, the element as a small icon top-left, a gold
 * fantasy checkmark top-right marking the slot as filled, the hero's
 * name, and a small gold-tinted role icon underneath — deliberately
 * lighter than HeroCollectionCard (no stats, no ability count), since
 * 5 of these sit in a single un-scrolled row and there's no room for
 * more. An empty slot is a dark card with a subtle purple border and
 * an "Add Demigod" placeholder. Shared between the Deck Builder's own
 * "PICK 5 DEMIGODS" row and Battle Preparation's reveal/draft rows. */
